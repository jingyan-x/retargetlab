...
- [x] 核对已有资产：旧数值工具矩阵偏转伸出轴90°；源开合轴按用户答复记录UNCONFIRMED。
- [x] 012/013给出固定摆位外包界排除证据及共同平移外包界；只作为必要条件。
- [x] 014/015完成保持+z对应的四个roll诊断，独立同帧最高2/60，无候选过门槛；014异常和015续跑分开保留。
- [ ] 登记保持已知伸出轴、位置与姿态共同评价的有界T2校准；未知roll仍标假设，不据得分认证。必要时形成限定范围的不适配报告。
